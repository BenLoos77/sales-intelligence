...
def build_cover_svg(c: dict, date_display: str, color: str) -> str:
    ...
    return (
        ...
        f'<text x="40" y="185" font-family="Space Grotesk, sans-serif" font-style="italic" font-weight="900" font-size="90" fill="#0a0a0a" letter-spacing="-3">{svg_text(c["kpi"])}</text>'
        ...
        f'<text x="40" y="293" font-family="Space Grotesk, sans-serif" font-style="italic" font-size="22" fill="#0a0a0a">{svg_text(c["italic1"])}</text>'
        f'<text x="40" y="321" font-family="Space Grotesk, sans-serif" font-style="italic" font-size="22" fill="#0a0a0a">{svg_text(c["italic2"])}</text>'
...
def build_hero_svg(h: dict, gid: str, color: str) -> str:
    ...
    return (
        ...
        f'  <text x="80" y="320" font-family="Space Grotesk, sans-serif" font-style="italic" font-weight="400" font-size="{big_size}" fill="#0a0a0a" letter-spacing="-8">{svg_text(big)}</text>\n'
        f'  <text x="{units_x}" y="320" font-family="Space Grotesk, sans-serif" font-style="italic" font-weight="400" font-size="150" fill="#0a0a0a" letter-spacing="-4">{svg_text(h.get("big_units", "/ 100"))}</text>\n'
        ...
        f'  <text x="80" y="472" font-family="Space Grotesk, sans-serif" font-style="italic" font-size="28" fill="#0a0a0a">{svg_text(h["italic1"])}</text>\n'
        f'  <text x="80" y="510" font-family="Space Grotesk, sans-serif" font-style="italic" font-size="28" fill="#0a0a0a">{svg_text(h["italic2"])}</text>\n'
        ...
        f'  <text x="560" y="588" font-family="Space Grotesk, sans-serif" font-style="italic" font-size="20" fill="#0a0a0a">{svg_text(h["right1"])}</text>\n'
        f'  <text x="560" y="618" font-family="Space Grotesk, sans-serif" font-style="italic" font-size="20" fill="#0a0a0a">{svg_text(h["right2"])}</text>\n'
        f'  <text x="560" y="648" font-family="Space Grotesk, sans-serif" font-style="italic" font-size="20" fill="#0a0a0a">{svg_text(h.get("right3", ""))}</text>\n'
...
def build_inline_fig(fig: dict) -> str:
    ...
    for i, col in enumerate(cols):
        x = [0, 360, 720][i]
        parts.append(f'        <text x="{x}" y="138" font-family="Space Grotesk, sans-serif" font-style="italic" font-size="80" fill="#0a0a0a">{svg_text(col.get("num", ""))}</text>')
        parts.append(f'        <text x="{x}" y="178" font-family="Space Grotesk, sans-serif" font-size="21" fill="#0a0a0a">{svg_text(col.get("head", ""))}</text>')
